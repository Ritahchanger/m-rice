...
const StageToolbar: React.FC<StageToolbarProps> = ({
  ...
  return (
    <div className="flex items-center justify-between overflow-x-auto gap-2 bg-gradient-to-r from-green-600 to-blue-600 px-4 py-2 shadow-sm rounded-sm border border-emerald-100 fixed right-[1rem] left-[1rem] stage-nav">
      {stages.map((stage) => {
        ...
        return (
          <button
            ...
            className={clsx(
              "flex items-center gap-2 px-4 py-2 whitespace-nowrap transition-all duration-150 shadow-sm",
              isCurrent
